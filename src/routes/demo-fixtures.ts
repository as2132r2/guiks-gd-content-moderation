...
export const MAIN_NOTICE = {
  ...
  sourceText: [
    ...
    '',
    '会议指出，今年以来全县上下紧扣产业兴旺这条主线，扎实推进乡村建设。全县产业园区累计完成投资 3.2亿元，建成标准化种植基地 18 个，覆盖 12 个乡镇，带动农户持续增收。',
    '',
    '会议要求，各乡镇各部门要压实责任、狠抓落实，把现场会精神转化为具体举措。下一步，县里将围绕产业配套、人才引育、基础设施三个方面持续发力，确保各项任务落地见效。',
  ].join('\n'),
} as const;
